...
public class MapGameController implements Initializable {
    ...
    // public MoveEnemy enemy2;
    // public MoveEnemy enemy3;
    ...
    public void func1ButtonAction(ActionEvent event) {
        try{
            ...
            MapGame.changeSceneByFXML("Start.fxml");
        } catch (Exception e){
            e.printStackTrace();
        }
    }
    ...
    public void func2ButtonAction(ActionEvent event) {
        try{
            ...
            t.stop();
            bgm.stop();
            MapGame.changeSceneByFXML("GameClear.fxml");
        } catch (Exception e){
            e.printStackTrace();
        }
    }
    ...
    public void func5ButtonAction(ActionEvent event){
        ...
        if(canAtk){
            ...
            //for(int i = 0; i < 4; i++){
            //    if(cy + dirInt[i][0] == ey && cx + dirInt[i][1] == ex){
            //        chara.setCharaDir(i);
            //        System.out.println("hakka");
            //        enemy.setPosX(enemy.getPastPosX());
            //        enemy.setPosY(enemy.getPastPosY());
            //        mapdata.setmap(ex, ey, mapdata.type_report1);
    ...
    public void keyAction(KeyEvent event){
        ...
        //score表示
        playerscore.setText("score: " + score + "/500000");
    ...
    public void printItemNumber(){
        item.setText("ITEM: " + chara.getCountItem());
    }
